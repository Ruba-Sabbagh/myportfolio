...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Ruba Alsabbagh</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('admin/contect')}}" class="nav-link @if(Request::segment(2)=='contect') active @endif">
                <i class="nav-icon fa fa-address-book"></i>
              <p>Contect</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{url('admin/blogs')}}" class="nav-link @if(Request::segment(2)=='blogs') active @endif">
